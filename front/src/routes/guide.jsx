...
const Beginner      = lazy(() => import('../pages/guide/beginner/index'));
const ClaudeGuide   = lazy(() => import('../pages/guide/claude/index'));
...
export const guideRoutes = [
  ...
  { path: '/guide/beginner',       element: <Beginner /> },
  { path: '/guide/claude',         element: <ClaudeGuide /> },
];
